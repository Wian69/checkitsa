    ...
    return (
        <nav style={{
            ...
            <div className="container" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                ...
                <div className="desktop-only" style={{ display: 'flex', gap: '2.5rem', fontWeight: 500, alignItems: 'center' }}>
                    <div style={{ display: 'flex', gap: '2rem', alignItems: 'center' }} className="nav-links">
                        ...
                        <Link href="/privacy-clean" style={{ fontSize: '0.9375rem', color: '#10b981', fontWeight: 600 }}>Clean My Data</Link>
            ...
            <div className={`mobile-nav-overlay ${mobileMenuOpen ? 'open' : ''}`}>
                ...
                <Link href="/privacy-clean" onClick={() => setMobileMenuOpen(false)} style={{ fontSize: '1.5rem', fontWeight: 600, color: '#10b981' }}>Clean My Data</Link>
